...
openmc.config["chain_file"] = "/nuclear_data/chain-endf-b7.1.xml"

my_material = openmc.Material()
my_material.add_nuclide("Xe135", 1e-12)
my_material.add_nuclide("U235", 1)
my_material.add_nuclide("U238", 1)
# my_material.add_nuclide("Fe56", 1)
# my_material.add_nuclide("Fe57", 1)
# my_material.add_nuclide("Fe55", 1)
# my_material.add_nuclide("Fe54", 1)
...
plt.yscale("log")  # modify axis from default settings
plt.savefig("gamma_spec2.png", bbox_inches='tight', dpi=300)